      ...
      case weatherTask:
        ...
        try {
          final responseList = await Future.wait([
            ...
            DioClient().client.get(
              '/${Endpoint.getUltraShortTermForecast}?serviceKey=${Environment.publicApiKey}&base_date=${TimeUtil.getTodayDate()}&base_time=${TimeUtil.getCurrentTime()}&nx=$nx&ny=$ny&numOfRows=$numOfRows&pageNo=$pageNo&dataType=$dataType',
            ),
          ]);
